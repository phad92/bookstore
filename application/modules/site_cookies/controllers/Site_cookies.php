...
function _attempt_get_id(){
    ...
    if(isset($_COOKIE[$cookie_name])){
        ...
        //is the cookie still valid or available
...
function _auto_delete_old(){
    $nowtime = time();
    $mysql_query = "DELETE FROM site_cookies WHERE expiry_date < ?";
    $this->db->query($mysql_query,array($nowtime));
}
