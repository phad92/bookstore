	...
	<div class="box span12">
		...
		<div class="box-content">
           <p>Choose a New Category</p> 
                     <?php $form_location = base_url('store_book_assign_author/submit/').$book_id;?>
...
<div style="margin-top: 30px">
    <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white tag"></i><span class="break"></span>Existing book Options</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
						  ...
						  <tbody>
												<?php 
														...
														foreach($query->result() as $row): 
															$count++;
                              $delete_url = base_url('store_book_assign_author/delete/'.$row->id);
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-danger" href="<?php echo $delete_url; ?>">
										<i class="halflings-icon white trash"></i> Remove Category
									</a>
								</td>
