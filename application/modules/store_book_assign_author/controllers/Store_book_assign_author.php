...
class Store_book_assign_author extends MX_Controller
{
...
function delete($update_id){
    ...
    redirect('store_book_assign_author/update/'.$book_id);
}
...
$this->load->model('Mdl_store_book_assign_author');
$query = $this->Mdl_store_book_assign_author->get($order_by);
return $query;
}

function get_with_limit($limit, $offset, $order_by) {
$this->load->model('Mdl_store_book_assign_author');
$query = $this->Mdl_store_book_assign_author->get_with_limit($limit, $offset, $order_by);
return $query;
}

function get_where($id) {
$this->load->model('Mdl_store_book_assign_author');
$query = $this->Mdl_store_book_assign_author->get_where($id);
return $query;
}

function get_where_custom($col, $value) {
$this->load->model('Mdl_store_book_assign_author');
$query = $this->Mdl_store_book_assign_author->get_where_custom($col, $value);
return $query;
}

function _insert($data) {
$this->load->model('Mdl_store_book_assign_author');
$this->Mdl_store_book_assign_author->_insert($data);
}

function _update($id, $data) {
$this->load->model('Mdl_store_book_assign_author');
$this->Mdl_store_book_assign_author->_update($id, $data);
}

function _delete($id) {
$this->load->model('Mdl_store_book_assign_author');
$this->Mdl_store_book_assign_author->_delete($id);
}

function count_where($column, $value) {
$this->load->model('Mdl_store_book_assign_author');
$count = $this->Mdl_store_book_assign_author->count_where($column, $value);
return $count;
}

function get_max() {
$this->load->model('Mdl_store_book_assign_author');
$max_id = $this->Mdl_store_book_assign_author->get_max();
return $max_id;
}

function _custom_query($mysql_query) {
$this->load->model('Mdl_store_book_assign_author');
$query = $this->Mdl_store_book_assign_author->_custom_query($mysql_query);
return $query;
}
