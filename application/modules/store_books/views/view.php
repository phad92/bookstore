...
<div class="container">
    <div class="row">
          <div class="col-md-4" style="margin-top:24px;">
            <a href="#" data-featherlight="<?php echo base_url('public/images/books/big_pics/'.$big_pic)?>">
                <img class="img-responsive" src="<?php echo base_url('public/images/books/big_pics/'.$big_pic)?>" title="<?php echo $big_pic?>" style="height: 450px;">
            </a>
          </div>
      ...
      <div class="col-md-5">
          <div class="container-fluid">
            <h3><?php echo $book_title?></h3>
                ...
                <?php 
                    $link_style = "style='font-size: 16px;text-decoration: none;font-weight: bold;'";
                    if(count($res) > 1){
                        foreach($res as $row){
                            
                            $author_links [] = "<a href='".base_url().$row."' $link_style>".ucwords(str_replace('-',' ',$row))."</a>";
                            // print_r($author_links);die();
                        }
                        echo implode(', ',$author_links);
                    }else{
                        // print_r($res);die();
                        echo "<a href='".base_url().$res[0]."' $link_style>".ucwords(str_replace('-',' ',$res[0]))."</a>";
                    }?>
    ...
    <div class="row">
        <div class="container">
            ...
            <div class="row" style="background: silver;margin: 20px 5px; padding: 15px 10px;">
                <h3>Books by Author</h3><hr>
                <div class="owl-carousel owl-theme">
                    <?php  foreach($books->result() as $row):
                        $book_url = base_url().$url_segment.$row->book_url;
                        ?>
