...
<div class="col-md-8 col-sm-12">
                ...
                $form_location = base_url().'checkout/submit_stripe_form';
                ...
                <div class="form-group">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="card_exp_month" maxlength="2" class="form-control" id="card-expiry-month" placeholder="MM" value="<?php echo set_value('exp_month'); ?>" required>
                                        
                    </div>
                    <div class="col-md-4">
                        <label class="control-label" for="card_exp_year">Year</label>  
                        <input type="text" name="card_exp_year" class="form-control" maxlength="4" id="card-expiry-year" placeholder="YYYY" required="" value="<?php echo set_value('exp_year'); ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="control-label" for="card_cvc">CVC</label>  
                        <input type="text" name="card_cvc" id="card-cvc" maxlength="3" class="form-control" autocomplete="off" placeholder="CVC" value="<?php echo set_value('cvc'); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="col-md-12">
                    ...
                    <input type="hidden" name="stripe_id" value="<?php echo $stripe_id?>">
...
<script>
    <?php $url_seg = $this->uri->segment(2);
          if($url_seg == "payment"):
    ?>
    $.post('<?php echo base_url("store_accounts/check_accounts_for_user/$user_id")?>',function(resp){
        if(resp.status == true){
            console.log(resp);
